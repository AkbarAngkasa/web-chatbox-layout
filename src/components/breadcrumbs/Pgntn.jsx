...
export default function Pgntn() {
  return (
    <div className='mx-[5%] sm:w-[50%] sm:m-auto h-screen grid grid-cols-1 place-content-center'>
      {/* Header */}
      <div>
          <Link to={"/"}>
          ...
          <div className='my-4 border-b-2 border-slate-300'>
              ...
              <h1 className='inline-block align-middle border-l-2 pl-2 font-bold text-xl sm:text-2xl text-blue-800'>Pagination Component</h1>
          </div>
      </div>
