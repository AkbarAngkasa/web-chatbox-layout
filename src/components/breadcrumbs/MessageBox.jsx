            ...
            <div className='w-full'>
                ...
                <div id="alert-1" className="flex p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                    ...
                    <div className="ml-3 text-sm font-medium">
                        A simple info alert with an <button href="#" className="font-semibold underline hover:no-underline">example link</button>. Give it a click if you like.
                    </div>
                ...
                <div id="alert-5" className="flex p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="alert">
                    ...
                    <div className="ml-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                        A simple dark alert with an <button href="#" className="font-semibold underline hover:no-underline">example link</button>. Give it a click if you like.
                    </div>
                ...
                <div id="alert-border-2" className="flex p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
                    <svg className="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
                    <div className="ml-3 text-sm font-medium">
                        A simple danger alert with an <button href="#" className="font-semibold underline hover:no-underline">example link</button>. Give it a click if you like.
                    </div>
                ...
                <div id="alert-border-3" className="flex p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800" role="alert">
                    <svg className="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
                    <div className="ml-3 text-sm font-medium">
                        A simple success alert with an <button href="#" className="font-semibold underline hover:no-underline">example link</button>. Give it a click if you like.
                    </div>
                ...
                <div id="alert-border-5" className="flex p-4 border-t-4 border-gray-300 bg-gray-50 dark:bg-gray-800 dark:border-gray-600" role="alert">
                    ...
                    <div className="ml-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                        A simple dark alert with an <button href="#" className="font-semibold underline hover:text-gray-800 hover:no-underline">example link</button>. Give it a click if you like.
                    </div>
