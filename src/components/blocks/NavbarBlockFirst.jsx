...
export default function NavbarBlockFirst() {
    useEffect(() => {
        initFlowbite();
    });
        ...
        <header>
            ...
            <nav className="py-5 px-5 flex flex-row justify-between align-middle bg-white border-gray-200 dark:bg-gray-800">
                ...
                <div className="flex flex-wrap justify-start">
                    ...
                    <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="mr-4 text-xl rounded-lg text-gray-500 dark:text-gray-400 dark:focus:ring-gray-600 sm:hidden">
                ...
                <div className='flex flex-wrap justify-end align-middle'>
                    ...
                    {/* User Button  */}
                    <button type="button" className="w-8 h-8 ml-4 text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    ...
                    <div className="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                        ...
                        <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                            <li>
                                <button href="#" className="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><svg className="mr-2 w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"></path></svg> My likes</button>
                            </li>
                            <li>
