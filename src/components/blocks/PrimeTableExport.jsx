                            ...
                            <div className='flex flex-col w-full sm:w-[50%]'>
                                ...
                                <div className='flex flex-row p-[5%] bg-slate-50'>
                                    ...
                                    <div className='w-[25%] pl-2 flex flex-col justify-end place-items-end'>
                                        <button type="button" className="px-3 py-2 mb-2 lg:mr-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Verify</button>
    ...
    return (
        <>
            <div className="card">
                ...
                <DataTable ref={dt} value={products} header={header} tableStyle={{ minWidth: '50rem' }} paginator rows={10} filters={filters} globalFilterFields={['register_time', 'account_no', 'phone_no', 'full_name', 'nik', 'user_status', 'user_kyc', 'action']} emptyMessage="Query not found." className='h-fit'>
