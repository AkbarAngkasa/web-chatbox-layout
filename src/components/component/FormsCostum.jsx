            ...
            <div className='w-full flex flex-col'>
                <form>
                    ...
                    <div className="flex items-start mb-6">
                        ...
                        <label htmlhtmlFor="ingat" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ingat saya</label>
                    </div>
                ...
                <div className="mb-6">
                    <label htmlhtmlFor="username-success" className="block mb-2 text-sm font-medium text-green-700 dark:text-green-500">Username</label>
                ...
                <div>
                    <label htmlhtmlFor="username-error" className="block mb-2 text-sm font-medium text-red-700 dark:text-red-500">Username</label>
                ...
                {/* Select input */}
                <label htmlhtmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih negara</label>
                ...
                <fieldset>
                    ...
                    <div className="flex items-center mb-4">
                        ...
                        <label htmlhtmlFor="checkbox-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Saya setuju dengan <button href="#" className="text-blue-600 hover:underline dark:text-blue-500">syarat dan ketentuan</button>.</label>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        ...
                        <label htmlhtmlFor="checkbox-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Saya ingin mendapatkan tawaran promosi</label>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        ...
                        <label htmlhtmlFor="checkbox-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Saya 18 tahun atau lebih tua</label>
                    </div>
                    ...
                    <div className="flex mb-4">
                        ...
                        <div className="ml-2 text-sm">
                            <label htmlhtmlFor="helper-checkbox" className="font-medium text-gray-900 dark:text-gray-300">Kupon diskon Emkop</label>
                    ...
                    <div className="flex items-center">
                        ...
                        <label htmlhtmlFor="international-shipping-disabled" className="ml-2 text-sm font-medium text-gray-400 dark:text-gray-500">Berhak asuransi (disabled)</label>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div className="flex items-center mb-4">
                        <input id="country-option-1" type="radio" name="countries" defaultValue="USA" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" checked/>
                            <label htmlhtmlFor="country-option-1" className="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Indonesia
                            </label>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        <input id="country-option-2" type="radio" name="countries" defaultValue="Germany" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600"/>
                            <label htmlhtmlFor="country-option-2" className="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Singapore
                            </label>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        <input id="country-option-3" type="radio" name="countries" defaultValue="Spain" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:bg-gray-700 dark:border-gray-600"/>
                            <label htmlhtmlFor="country-option-3" className="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Malaysia
                            </label>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        <input id="country-option-4" type="radio" name="countries" defaultValue="United Kingdom" className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring:blue-300 dark:focus-ring-blue-600 dark:bg-gray-700 dark:border-gray-600"/>
                            <label htmlhtmlFor="country-option-4" className="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Thailand
                            </label>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        disabled/>
                            <label htmlhtmlFor="option-disabled" className="block ml-2 text-sm font-medium text-gray-300 dark:text-gray-700">
                                China (disabled)
                            </label>
                    </div>
                </fieldset>
                ...
                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" htmlhtmlFor="user_avatar">Upload file</label>
