        ...
        <div className='mx-[5%] lg:w-[50%] lg:mx-auto my-10 grid grid-cols-1 place-content-center'>
            ...
            <div className='w-full'>
                ...
                <div className="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                    ...
                    <div>
                        <span className="font-medium">Informasi!</span> Ini adalah Component Message Box, untuk menampilkan peringatan.
                    </div>
                </div>
                <div className="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div>
                        <span className="font-medium">Bahaya!</span> Ini adalah Component Message Box, untuk menampilkan peringatan.
                    </div>
                </div>
                <div className="flex p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div>
                        <span className="font-medium">Berhasil!</span> Ini adalah Component Message Box, untuk menampilkan peringatan.
                    </div>
                </div>
                <div className="flex p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div>
                        <span className="font-medium">Peringatan!</span> Ini adalah Component Message Box, untuk menampilkan peringatan.
                    </div>
                </div>
                <div className="flex p-4 text-sm text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-300" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div>
                        <span className="font-medium">Opsional!</span> Ini adalah Component Message Box, untuk menampilkan peringatan.
                    </div>
                </div>
                ...
                <div className="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div>
                        <span className="font-medium">Pastikan persyaratan berikut terpenuhi:</span>
                        <ul className="mt-1.5 ml-4 list-disc list-inside">
                            <li>Minimal 10 karakter (dan maksimal 100 karakter)</li>
                            <li>Minimal memiliki satu huruf kapital</li>
                            <li>Termasuk minimal satu karakter spesial, contoh., ! @ # ?</li>
                        </ul>
                    </div>
                </div>
                <div className="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                ...
                <div id="alert-1" className="flex p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                    ...
                    <div className="ml-3 text-sm font-medium">
                        Pesan Informasi sederhana dengan <button href="#" className="font-semibold underline hover:no-underline">link contoh</button>. Silakan klik jika ingin.
                    </div>
                ...
                <div id="alert-2" className="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div className="ml-3 text-sm font-medium">
                        Pesan Bahaya sederhana dengan <button href="#" className="font-semibold underline hover:no-underline">link contoh</button>. Silakan klik jika ingin.
                    </div>
                ...
                <div id="alert-3" className="flex p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                    ...
                    <span className="sr-only">Info</span>
                    <div className="ml-3 text-sm font-medium">
                        Pesan Berhasil sederhana dengan <button href="#" className="font-semibold underline hover:no-underline">link contoh</button>. Silakan klik jika ingin.
                    </div>
                ...
                <div id="alert-4" className="flex p-4 mb-4 text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">
                    <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
                    <span className="sr-only">Info</span>
                    <div className="ml-3 text-sm font-medium">
                        Pesan Peringatan sederhana dengan <button href="#" className="font-semibold underline hover:no-underline">link contoh</button>. Silakan klik jika ingin.
                    </div>
                    <button type="button" className="ml-auto -mx-1.5 -my-1.5 bg-yellow-50 text-yellow-500 rounded-lg focus:ring-2 focus:ring-yellow-400 p-1.5 hover:bg-yellow-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-yellow-300 dark:hover:bg-gray-700" data-dismiss-target="#alert-4" aria-label="Close">
                        <span className="sr-only">Close</span>
                        <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                    </button>
                </div>
                <div id="alert-5" className="flex p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="alert">
                    <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-gray-800 dark:text-gray-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
                    <span className="sr-only">Info</span>
                    <div className="ml-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                        Opsional dengan <button href="#" className="font-semibold underline hover:no-underline">link contoh</button>. Silakan klik jika ingin.
                    </div>
                    <button type="button" className="ml-auto -mx-1.5 -my-1.5 bg-gray-50 text-gray-500 rounded-lg focus:ring-2 focus:ring-gray-400 p-1.5 hover:bg-gray-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white" data-dismiss-target="#alert-5" aria-label="Close">
                ...
                <div id="alert-border-4" className="flex p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-300 dark:bg-gray-800 dark:border-yellow-800" role="alert">
                    ...
                    <button type="button" className="ml-auto -mx-1.5 -my-1.5 bg-yellow-50 text-yellow-500 rounded-lg focus:ring-2 focus:ring-yellow-400 p-1.5 hover:bg-yellow-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-yellow-300 dark:hover:bg-gray-700" data-dismiss-target="#alert-border-4" aria-label="Close">
                        <span className="sr-only">Dismiss</span>
                        <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                    </button>
                </div>
                <div id="alert-border-5" className="flex p-4 border-t-4 border-gray-300 bg-gray-50 dark:bg-gray-800 dark:border-gray-600" role="alert">
                    ...
                    <div className="ml-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                        Opsional sederhana dengan <button href="#" className="font-semibold underline hover:text-gray-800 hover:no-underline">link contoh</button>. Silakan klik jika ingin.
                    </div>
                ...
                <div id="alert-additional-content-1" className="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
                    ...
                    <div className="mt-2 mb-4 text-sm">
                        Informasi lebih mengenai Informasi berada disini, textnya sedikit lebih panjang supaya component dapat terdemonstrasi dengan lebih jelas.
                    </div>
                    <div className="flex">
                ...
                <div id="alert-additional-content-2" className="p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                    <div className="flex items-center">
                        <svg aria-hidden="true" className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
                        <span className="sr-only">Info</span>
                        <h3 className="text-lg font-medium">Bahaya</h3>
                    </div>
                    <div className="mt-2 mb-4 text-sm">
                        Informasi lebih mengenai danger berada disini, textnya sedikit lebih panjang supaya component dapat terdemonstrasi dengan lebih jelas.
                    </div>
                    <div className="flex">
                ...
                <div id="alert-additional-content-3" className="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
                    ...
                    <div className="mt-2 mb-4 text-sm">
                        Informasi lebih mengenai success berada disini, textnya sedikit lebih panjang supaya component dapat terdemonstrasi dengan lebih jelas.
                    </div>
                    <div className="flex">
                ...
                <div id="alert-additional-content-4" className="p-4 mb-4 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800" role="alert">
                    <div className="flex items-center">
                        <svg aria-hidden="true" className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
                        <span className="sr-only">Info</span>
                        <h3 className="text-lg font-medium">Peringatan</h3>
                    </div>
                    <div className="mt-2 mb-4 text-sm">
                        Informasi lebih mengenai warning berada disini, textnya sedikit lebih panjang supaya component dapat terdemonstrasi dengan lebih jelas.
                    </div>
                    <div className="flex">
                        <button type="button" className="text-white bg-yellow-800 hover:bg-yellow-900 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center dark:bg-yellow-300 dark:text-gray-800 dark:hover:bg-yellow-400 dark:focus:ring-yellow-800">
                            <svg aria-hidden="true" className="-ml-0.5 mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path><path fillRule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clipRule="evenodd"></path></svg>
                            Lebih lanjut
                        </button>
                ...
                <div id="alert-additional-content-5" className="p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800" role="alert">
                    <div className="flex items-center">
                        ...
                        <span className="sr-only">Info</span>
                        <h3 className="text-lg font-medium text-gray-800 dark:text-gray-300">Opsional</h3>
                    </div>
                    <div className="mt-2 mb-4 text-sm text-gray-800 dark:text-gray-300">
                        Informasi lebih mengenai opsional berada disini, textnya sedikit lebih panjang supaya component dapat terdemonstrasi dengan lebih jelas.
                    </div>
                    <div className="flex">
